        ...
        <div className="grid md:grid-cols-5 gap-6">
          ...
          <div className="md:col-span-2">
            <div className="rounded-xl border border-border/60 bg-card p-4 space-y-3 sticky top-24">
              ...
              <Button className="w-full" onClick={handlePlaceOrder} disabled={createOrderMutation.isPending || !selectedAddressId}>
                {t("checkout.place_order")}
              </Button>
              <p className="text-[10px] text-muted-foreground text-center">You'll be directed to USDD payment</p>
            </div>
          </div>
        </div>
      </div>
