CREATE TYPE IF NOT EXISTS "public"."card_color" AS ENUM('silver', 'gold', 'platinum', 'black');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."card_status" AS ENUM('pending', 'active', 'suspended', 'rejected');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."chat_role" AS ENUM('user', 'assistant');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."deposit_status" AS ENUM('pending', 'confirmed', 'rejected', 'refunded', 'forfeited');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."dropship_order_status" AS ENUM('pending', 'accepted', 'shipped', 'delivered', 'cancelled');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."external_platform" AS ENUM('tiktok', 'pinduoduo', 'xiaohongshu', 'amazon', 'shein', 'taobao', 'jd', 'lazada', 'shopee', 'other');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."group_status" AS ENUM('open', 'completed', 'expired', 'cancelled');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."group_tx_status" AS ENUM('pending', 'completed', 'refunded');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."group_type" AS ENUM('standard', 'flash', '万人团');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."joined_via" AS ENUM('direct', 'whatsapp', 'telegram', 'wechat', 'twitter', 'copy');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."notif_type" AS ENUM('new_order', 'order_status', 'withdrawal_status', 'deposit_status', 'referral_reward', 'system');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."order_status" AS ENUM('pending_payment', 'paid', 'shipped', 'completed', 'cancelled');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."quote_org_type" AS ENUM('ngo', 'military', 'government', 'medical', 'other');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."quote_status" AS ENUM('pending', 'reviewed', 'quoted', 'accepted', 'rejected');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."quote_urgency" AS ENUM('standard', 'urgent', 'critical');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."referral_reward_status" AS ENUM('pending', 'confirmed', 'paid', 'cancelled');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."repayment_status" AS ENUM('pending', 'submitted', 'approved', 'rejected');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."store_order_status" AS ENUM('pending_payment', 'paid', 'shipped', 'completed', 'cancelled');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."store_status" AS ENUM('pending', 'active', 'suspended', 'rejected');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."store_type" AS ENUM('influencer', 'supply_chain', 'brand');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."submission_type" AS ENUM('wechat_moments', 'community_trade', 'social_media', 'referral_signup');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."usdd_tx_status" AS ENUM('pending', 'confirmed', 'rejected', 'completed');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."usdd_tx_type" AS ENUM('deposit', 'payment', 'refund', 'reward', 'withdrawal', 'adjustment');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."user_role" AS ENUM('user', 'admin');--> statement-breakpoint
CREATE TYPE IF NOT EXISTS "public"."withdrawal_status" AS ENUM('pending', 'approved', 'rejected', 'paid');--> statement-breakpoint
